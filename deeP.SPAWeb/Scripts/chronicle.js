    ...
    function equals(o1, o2) {
        ...
        if (t1 == t2) {
            ...
            if (t1 == 'object') {
                ...
                } else if ((moment.isMoment(o1) && !moment.isMoment(o2)) || (moment.isMoment(o2) && !moment.isMoment(o1))) {
                    return { isEqual: moment(new Date(o1)).isSame(moment(new Date(o2))), unequalVariable: '', stringDiff: false, o1: o1, o2: o2 };
